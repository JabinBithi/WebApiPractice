...
namespace WebApplication1.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<bool> updateProductByIdNoAsync(ProductInfo product)
        {
            ...
            existing.RollNo = product.RollNo;
            existing.GSM = product.GSM;
            existing.Width = product.Width;
            existing.ColorFastness = product.ColorFastness;
            existing.PillingTest = product.PillingTest;
            existing.Twist = product.Twist;
